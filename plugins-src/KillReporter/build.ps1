...
$OutJar = Join-Path $PSScriptRoot 'build\KillReporter.jar'
...
Copy-Item $OutJar (Join-Path $PluginsDir 'KillReporter.jar') -Force
Write-Host "Built and copied plugin to $PluginsDir\KillReporter.jar"
