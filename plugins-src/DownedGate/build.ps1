...
$OutJar = Join-Path $PSScriptRoot 'build\DownedGate.jar'
...
Copy-Item $OutJar (Join-Path $PluginsDir 'DownedGate.jar') -Force
Write-Host "Built and copied plugin to $PluginsDir\DownedGate.jar"
