...
$OutJar = Join-Path $PSScriptRoot 'build\\DeathsReporter.jar'
...
# Create plugin jar with classes and resources at root
...
Copy-Item $OutJar (Join-Path $PluginsDir 'DeathsReporter.jar') -Force
Write-Host "Built and copied plugin to $PluginsDir\\DeathsReporter.jar"
