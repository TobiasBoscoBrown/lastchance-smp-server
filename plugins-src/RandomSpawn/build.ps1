...
$OutJar = Join-Path $PSScriptRoot 'build\RandomSpawn.jar'
...
Copy-Item $OutJar (Join-Path $PluginsDir 'RandomSpawn.jar') -Force
Write-Host "Built and copied plugin to $PluginsDir\RandomSpawn.jar"
