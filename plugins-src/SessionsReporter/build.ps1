...
$OutJar = Join-Path $PSScriptRoot 'build\SessionsReporter.jar'
...
# Compile against server.jar and all libraries for transitive deps
...
Copy-Item $OutJar (Join-Path $PluginsDir 'SessionsReporter.jar') -Force
Write-Host "Built and copied plugin to $PluginsDir\SessionsReporter.jar"
